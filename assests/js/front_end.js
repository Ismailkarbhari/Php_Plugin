jQuery(document).ready(function($) {
	...
	var settings = {
  	"url": "https://apnabazarnj.com/wp-json/area/v1/website_all",
...
//     $(".popup").fadeOut(500);
//     } 
	 else if (pageURL == "https://apnabazarnj.com/products/") {
    $(".popup").show();
    } 
	if (pageURL.includes('?'))
	{
    ...
    $("#test").on('keyup',function(e){
     ...
     var settings = {
            "url": "https://apnabazarnj.com/wp-json/area/v1/website_like",
...
//           console.log(response);
      ...
      $(".close").click(function() {
        ...
        window.location.href = "https://apnabazarnj.com/";
      });
});
