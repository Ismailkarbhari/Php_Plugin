...
if(!class_exists( 'MultiPluginClass' ) ){
    ...
    class MultiPluginClass{
        ...
        function custom_shortcode_func() {
            ...
            ?>
<h5>Location</h5>
<span id="btnchange" class="btnchange"></span><a class="change"><span><i class="fa fa-pencil-square-o"></i></span></a>
<section class="popup">
  <div class="popup__content">
    ...
    <div class="estate">
    <input type="text" class="form-control" id="test" placeholder="Enter Area Or Pincode">
        </div>
